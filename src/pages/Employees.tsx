    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-2xl font-semibold leading-6 text-gray-900">Funcionários</h1>
          <p className="mt-2 text-sm text-gray-700">
            Lista de todos os funcionários da empresa que podem receber equipamentos.
          </p>
        </div>
              ...
              <table className="min-w-full divide-y divide-gray-300">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {loading ? (
                    ...
                    <tr>
                      <td colSpan={6} className="text-center py-4 text-gray-500">Nenhum funcionário encontrado.</td>
                    </tr>
                  ) : (
                    users.map((user) => (
                      <tr key={user.id}>
